...
type AuctionServiceClient interface {
	...
	ServerIsDesynchronized(ctx context.Context, in *CorrectValue, opts ...grpc.CallOption) (*Ack, error)
}
...
func (c *auctionServiceClient) ServerIsDesynchronized(ctx context.Context, in *CorrectValue, opts ...grpc.CallOption) (*Ack, error) {
	out := new(Ack)
...
type AuctionServiceServer interface {
	...
	ServerIsDesynchronized(context.Context, *CorrectValue) (*Ack, error)
...
func (UnimplementedAuctionServiceServer) ServerIsDesynchronized(context.Context, *CorrectValue) (*Ack, error) {
...
func _AuctionService_ServerIsDesynchronized_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuctionServiceServer).ServerIsDesynchronized(ctx, req.(*CorrectValue))
	}
	return interceptor(ctx, in, info, handler)
}
