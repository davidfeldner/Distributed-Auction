...
type AuctionServiceClient interface {
	...
	Result(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*ResultRequest, error)
	ServerIsDesynchronized(ctx context.Context, in *ResultRequest, opts ...grpc.CallOption) (*Ack, error)
}
...
func (c *auctionServiceClient) Result(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*ResultRequest, error) {
...
func (c *auctionServiceClient) ServerIsDesynchronized(ctx context.Context, in *ResultRequest, opts ...grpc.CallOption) (*Ack, error) {
	out := new(Ack)
...
type AuctionServiceServer interface {
	...
	Result(context.Context, *EmptyMessage) (*ResultRequest, error)
	ServerIsDesynchronized(context.Context, *ResultRequest) (*Ack, error)
...
func (UnimplementedAuctionServiceServer) Result(context.Context, *EmptyMessage) (*ResultRequest, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Result not implemented")
}
func (UnimplementedAuctionServiceServer) ServerIsDesynchronized(context.Context, *ResultRequest) (*Ack, error) {
...
func _AuctionService_ServerIsDesynchronized_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuctionServiceServer).ServerIsDesynchronized(ctx, req.(*ResultRequest))
	}
	return interceptor(ctx, in, info, handler)
}
